          ...
          {title ? (
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="flex justify-center items-start self-stretch [background:var(--background-normal-25,#F6F8FA)] shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] pl-12 pr-4 pt-[13px] pb-3.5 rounded-lg"
              />
