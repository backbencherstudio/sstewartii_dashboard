    ...
    return (
        <div className='w-full flex flex-col items-center gap-4 flex-[1_0_0] self-stretch border border-[#ECEFF3] [background:var(--Background-White,#FFF)] shadow-[0_0_16px_0_rgba(0,0,0,0.06)] p-6 rounded-2xl border-solid'>
            ...
            <div className='w-full '>
                <h3 className='flex-[1_0_0] text-[color:var(--Stroke,#2A3542)] [font-family:Lora] text-lg font-bold leading-[130%] pb-2'>Customer Reports Details</h3>
            </div>
            ...
            <div className='w-full  flex justify-between items-center'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  w-full">
                    ...
                    <StatCard label="Cancelled Order" value="7" />
                    <StatCard label="Incomplete Orders" value="37" />
                    <StatCard label="Report Count" value="34" />
                    <StatCard label="Vendor Count" value="7" />
                    <StatCard label="Last Ordered" value="12-02-2026" />
                </div>
...
function StatCard({ label, value }: { label: string; value: string | number }) {
    return (
        <div className="bg-white p-2 border border-[#ECEFF3] rounded-2xl shadow-sm">
            <p className="h-5 self-stretch text-[color:var(--Secondary-Text,#697586)] [font-family:Inter] text-xs font-normal leading-[120%] ">{label}</p>
