...
const Ordercon = () => <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M22.4315 19.7471H1.56848C1.25581 19.7471 1 20.0029 1 20.3155C1 20.6282 1.25581 20.884 1.56848 20.884H22.4315C22.7442 20.884 23 20.6282 23 20.3155C23 20.0029 22.7442 19.7471 22.4315 19.7471Z" fill="white" stroke="white" strokeWidth="0.4" />
</svg>
