...
import { ChevronDown, ChevronUp, UserMinus, UserX } from 'lucide-react'
                ...
                <div>
                    ...
                    <DropdownMenu open={isOpen} onOpenChange={handleOpen}>
                        <DropdownMenuTrigger asChild>
                            <button className='btn-primary'> <span>Manage Vendor </span>
                        ...
                        <DropdownMenuContent align='end' className="w-64 rounded-xl bg-[#F8FAFC] border-none shadow-lg p-0">
                            ...
                            <DropdownMenuItem className="cursor-pointer gap-3 px-5 py-4 text-slate-700 hover:bg-slate-100 rounded-lg">
                            ...
                            <hr />
                            <DropdownMenuItem className="cursor-pointer gap-3 px-5 py-4 text-red-600 hover:bg-red-50 rounded-lg">
