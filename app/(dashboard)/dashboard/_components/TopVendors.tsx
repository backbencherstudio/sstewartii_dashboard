  ...
  return (
    <div className="w-full p-6 bg-white rounded-3xl border border-gray-100 shadow-sm font-sans">
      ...
      <div className="flex justify-between items-center mb-8">
        <h3 className="text-xl font-bold text-gray-900">Top 5 Vendors</h3>
        <div className="flex bg-gray-100 p-1 rounded-xl gap-1">
          <button 
            onClick={() => setActiveTab('sales')}
            className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all ${
              activeTab === 'sales' ? 'bg-[#FFBB1C] text-black shadow-sm' : 'text-gray-500'
            }`}
          >
            By Sales
          </button>
          <button 
            ...
            className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all ${
              activeTab === 'revenue' ? 'bg-[#FFBB1C] text-black shadow-sm' : 'text-gray-500'
            }`}
          >
            By Revenue
          </button>
